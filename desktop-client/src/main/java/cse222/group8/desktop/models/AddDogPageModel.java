...
/**
 * The type Add dog page model.
 */
public class AddDogPageModel extends PageWithTokenModel{
    ...
    public AnimalData getAnimalData(){
        return new AnimalData(animalId,name,"dog",kind,gender,age,vaccination,neutered,info,false);
    }
