...
public class AnimalDataWithImage extends AnimalData{
    ...
    public AnimalDataWithImage(int id, String name, String breed, String kind, char gender, String age, String vaccination, boolean neutered, String info, boolean adoptRequested, String image) {
